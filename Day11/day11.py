...
def calculate_score(card_list):
    """Takes a list of cards and returns the score or sum"""
...
def black_jack():
    ...
    while not game_ended:
        if computer_score == 0 or user_score == 0 or user_score > 21:
            ...
            # Hint 10: If the game has not ended, ask the user if they want to draw another ca
    ...
    def compare(user_score, computer_score):
        if computer_score == 0:
            print("Computer Blackjack, You loose")
        elif user_score == 0:
...
# computer and user both have the same score, then it's a draw. If the computer has a blackjack (0), then the user loses.
